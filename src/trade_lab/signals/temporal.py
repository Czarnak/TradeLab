...
class CyclicalTemporalSignal(BaseSignal):
    ...
    Reads from df.index (must be DatetimeIndex) — never accepts a source signal.
    ...
    def __init__(self, component: str, period: float):
        super().__init__(source=None)  # index-based, never chained
